...
public class PraiseListView extends TextView {
    ...
    //    private List<DynamicDetailVM.DataBean.LikeBean> datas;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.black));
...
//    public List<DynamicDetailVM.DataBean.LikeBean> getDatas() {
//        return datas;
//    }

//    public void setDatas(List<DynamicDetailVM.DataBean.LikeBean> datas) {
//        this.datas = datas;
...
//            DynamicDetailVM.DataBean.LikeBean item = null;
...
//        setMovementMethod(new CircleMovementMethod(itemSelectorColor));
    ...
    private SpannableString setImageSpan() {
        ...
        imgSpanText.setSpan(new ImageSpan(App.getInstance(), R.drawable.like_yellow, DynamicDrawableSpan.ALIGN_BASELINE),
